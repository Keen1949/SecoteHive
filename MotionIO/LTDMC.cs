...
namespace csLTDMC //命名空间根据应用程序修改
{
    public enum DMC3400_DEFINE
    {
        ...
        MOTION_ERR_HANDLEERR = 9,
        ERR_SENDERR = 10,
        ERR_FIRMWAREERR = 12,
        ERR_FIRMWAR_MISMATCH = 14,
        ERR_FIRMWARE_INVALID_PARA_ERR = 20,
        ERR_FIRMWARE_STATE_ERR = 22,
        ERR_FIRMWARE_CARD_NOT_SUPPORT = 24
    };
